...
export const updateTicket = async (req, res) => {
    ...
    const updatedTicket = await TicketMessage.findByIdAndUpdate(_id, {...ticket, updated_At: Day}, {new: true});
...
export const deleteTicket = async(req, res) => {
    ...
    const deletedTicket = await TicketMessage.findByIdAndUpdate(_id, {...ticket,ticket_desc, deleted_At:Day,isDelete:true,_id: _id}, {new: true});
